...
public class DadosPopulados {
	...
	private List<ListaModeloGeral> listaDeUsuarios() {
		...
		ListaModeloGeral usuario1 = new ListaModeloGeral("Felipe", "0000", "1234", "cliente", "cc", 1, 100.00, 1);
		ListaModeloGeral usuario2 = new ListaModeloGeral("Joao", "1111", "1234", "cliente", "cc", 1, 100.00, 1);
		ListaModeloGeral usuario3 = new ListaModeloGeral("Ana", "2222", "1234", "gerente", "cp", 1, 100.00, 1);
		ListaModeloGeral usuario4 = new ListaModeloGeral("Maria", "3333", "1234", "diretor", "cc", 1, 100.00, 1);
		ListaModeloGeral usuario5 = new ListaModeloGeral("Antonio", "4444", "1234", "presidente", "cc", 1, 100.00, 1);
