		...
		if (usuarioLogado != null) {
			if (usuarioLogado instanceof Cliente) {
				Cliente cliente = (Cliente) usuarioLogado;										
					System.out.println("\nTITULAR: "+cliente.getNome().toUpperCase()+" | CONTA "+cliente.getConta().getTipo_conta()+" - N�MERO: "+cliente.getConta().getNumConta()+" - AG�NCIA: "+cliente.getConta().getAgencia()+" |");
		...
		if (usuarioLogado != null)
			if (usuarioLogado instanceof Cliente) {
				...
				if(cliente.getConta().getTipo_conta()==TipoContas.POUPANCA) {
					System.out.println("\nTITULAR: "+cliente.getNome()+" | CONTA "+cliente.getConta().getTipo_conta()+" - N�MERO: "+cliente.getConta().getConta()+" - AG�NCIA: "+cliente.getConta().getAgencia()+" |");
